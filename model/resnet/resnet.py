...
class ResNetEncoder(nn.Module):
    def __init__(
        ...
        if isinstance(observation_space, int):
            self._n_input_rgb = 3
            self._n_input_depth = 0#1 if observation_space > 3 else 0
            spatial_size = 64
        else:
            ...
            if "panoramic_depth" in observation_space.spaces:
                ...
                print(observation_space.spaces["panoramic_depth"].shape,"wqeqwe2")
            else:
        ...
        if not self.is_blind:
            ...
            #print(after_compression_flat_size, num_compression_channels)
