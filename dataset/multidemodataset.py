...
class HabitatDemoMultiGoalDataset(data.Dataset):
    ...
    def pull_image(self, index):
        ...
        start_idx = np.random.randint(10) if orig_data_len > 10 else 0
        end_idx = - 1
        ...
        if len(demo_dep.shape)==3:
            demo_dep=demo_dep[...,None]
       # print(demo_dep.shape,"dddddddddddddemoo",demo_rgb.shape)
